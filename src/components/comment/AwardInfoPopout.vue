      ...
      <div class="popout_box_bot">
        ...
        <div class="input_box">
          <uinput
            ...
            labelPosition="right"
            v-model="bankCard"
            @inputclear="bankCard = $event.clear"
          ></uinput>
          <uinput
            class="input_box_uinput"
            :onlyInput="false"
            ...
            labelPosition="right"
            v-model="userName"
            @inputclear="userName = $event.clear"
          ></uinput>
          <uinput
            class="input_box_uinput"
            :onlyInput="false"
            ...
            labelPosition="right"
            v-model="idCardNo"
            @inputclear="idCardNo = $event.clear"
          ></uinput>
          <uinput
            class="input_box_uinput"
            :onlyInput="false"
          ...
          <uinput
            ...
            @inputclear="sendCode = $event.clear"
          ></uinput>
        </div>
...
export default {
  ...
  methods: {
    ...
    confirmPost() {
      ...
      this.$emit(
        'click',
        [this.bankCard, this.userName, this.idCardNo, this.sendCode].join('-')
      )
    },
    //发送手机验证码
    authCode() {
      ...
      this.getRequest(url, requestParam)
        .then((res) => {
          this.$g_loadingHide()
