<template>
  <div class="hello_confirm">
    ...
    padding-right: 20px;">
          <my-process style="width: 75px;" :brd-rs="10" :pcs-height="14" :process-dept=0 bg-color="#E6A23C"
                      :show-striped="true"
                      :show-act="true"/>
        ...
        data() {
            return {
                ...
                scheduleList: [
                    ...
                    {name: '简历过筛', allmount: '1000', currentamount: '0'},
                    {name: '完成面试', allmount: '1000', currentamount: '0'},
                    {name: '发放offer', allmount: '1000', currentamount: '0'},
                ],
                userActBonus: [],/*奖励明细*/
