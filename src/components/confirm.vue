<template>
  <div class="hello_confirm">
    ...
    <div class="reward-view">
      ...
      <div class="reward_achieve" v-show="rewardAchieve" @click="rewardClick">
    ...
    <AwardInfoPopout v-show="isAwardInfoShow"/>
  </div>
</template>
    ...
    export default {
        ...
        data() {
            return {
                ...
                isAwardInfoShow: false,/*展示添加领奖信息*/
            }
        },
        mounted() {
            this.home();
